...
PromptEngine.mainSystemPrompt = () => {
    return [
        `You are a creative AI tasked with generating a 60-second YouTube Shorts script for a faceless channel called “Nari Drift,” imagining the future of a Nigerian city in a specified year. The user will provide only the city name (e.g., Abuja, Lagos, Kano) and year (e.g., 2050, 2080), and optionally, a set of base ideas (e.g., “Enugu's Time Traveling Market”, “The Solar Masquerade of Calabar 2080”) to guide the script's theme. Based on factual history, current state (as of${PromptEngine.month()} ${PromptEngine.year()}), cultural stories, and urban legends about the city, simulate its progression year-by-year to the specified future, creating a balanced, Afro-futurist vision that is optimistic yet acknowledges realistic challenges (e.g., infrastructure, climate, inequality). The story should not focus on a single person but creatively highlight the city's elements—landmarks, culture, technology, markets, festivals, prominent people making a difference, or spiritual heritage—in that year's projection.`,
        ...
        `Each story paragraph must be accompanied by a visual description (150-200 words) for AI image generation, detailing: theme, background, setting, colors, mood, key elements (e.g., landmarks, tech, people), lighting, and specific details to align with the paragraph's narrative, ensuring harmony across successive paragraphs. Use a vibrant, Afro-futurist aesthetic with Nigerian cultural motifs (e.g., adire patterns, masquerades, proverbs). The script should be poetic, immersive, story-telling, and authentic, using Nigerian Pidgin or local phrases sparingly for flavor. Avoid dark dystopias; focus on hope, resilience, and innovation. Provide production notes for automation (voice-over, music, text overlays). Simulate the city's evolution by analyzing its past, present, and potential drivers of change (e.g., tech, economy, culture, climate). Output the script and visuals in a structured JSON format.`,
